...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Game
    {
        ...
        // delay support
        const int TotalDelayMilliseconds = 6000;
        ...
        protected override void LoadContent()
        {
            ...
            piedra0 = Content.Load<Texture2D>(@"Graphics\greenrock");
            piedra1 = Content.Load<Texture2D>(@"Graphics\magentarock");
            piedra2 = Content.Load<Texture2D>(@"Graphics\whiterock");
            rock0 = new Rock(GetRandomSprite(), centerLocation,GetRandomVelocity(), WindowWidth, WindowHeight);
            rock1 = new Rock(GetRandomSprite(), centerLocation,GetRandomVelocity(), WindowWidth, WindowHeight);
            rock2 = new Rock(GetRandomSprite(), centerLocation, GetRandomVelocity(), WindowWidth, WindowHeight);
