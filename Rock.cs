...
namespace ProgrammingAssignment3
{
    ...
    public class Rock
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (outsideWindow == false)//drawRectangle.Top < 0 && drawRectangle.Bottom > windowHeight && drawRectangle.Left < 0 && drawRectangle.Right > windowWidth)
            {
            ...
            if (drawRectangle.Top > 0 || drawRectangle.Bottom < 600 || drawRectangle.Left > 0 || drawRectangle.Right < 800)
            {
               // drawRectangle.X = (int)(velocity.X);
               // drawRectangle.Y = (int)(velocity.Y);
                outsideWindow = true;
